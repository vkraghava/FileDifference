...
import com.example.text.model.Answer;
import com.example.text.model.Query;
...
public class FileCreatorXML{
    ...
    public static void main(String[] args) throws Exception{
        JAXBContext contextObj = JAXBContext.newInstance(Query.class);
        ...
        Query que=new Query(1,"What is java?",list);
